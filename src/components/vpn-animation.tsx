      ...
      >
        ...
        >
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div
              className="h-48 w-48 rounded-full border-2 border-dashed border-primary/20 animate-spin-slow"
              style={{ transform: 'translateZ(20px)' }}
            />
          </div>
           <div className="absolute inset-0 flex items-center justify-center">
            <div
              className="h-64 w-64 rounded-full border-2 border-dashed border-primary/20 animate-spin-medium"
              style={{ animationDelay: '0.5s', transform: 'translateZ(0px)' }}
            />
          </div>
           <div className="absolute inset-0 flex items-center justify-center">
            <div
              className="h-80 w-80 rounded-full border border-dashed border-primary/10 animate-spin-reverse-slow"
